...
Zum aktuellen Zeitpunkt wurden Stages als Beta-Funktionalität hinzugefügt.\footnote{https://docs.travis-ci.com/user/build-stages/} Damit lassen sich Schritte definieren, die einer Stage zugeordnet sind (siehe \lstref{lst:travis-config}).
...
Es gibt eine komplette Historie der Build-Prozesse (siehe \figref{fig:travis-history}) und eine Übersicht der letzten Builds eines Branches (siehe \figref{fig:travis-branch}).
