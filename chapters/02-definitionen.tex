...
Eine technisch funktionierende Anwendung ist jedoch noch nicht zwangsläufig eine Anwendung, die auch direkt an den Nutzer gegeben werden kann. Demnach kann als zweite Stage beispielsweise ein Akzeptanztest (siehe \fullref{subsec:def-testing}) durchgeführt werden. Möglich sind dann sogar Stages, die erst nach der Authorisierung durch einen Menschen fortgesetzt werden können. \citep{FowlerDP}
